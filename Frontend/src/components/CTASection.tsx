...
export default function CTASection() {
  ...
  const trustBadges = [
    { emoji: "🔒", text: t.trustFully },
    { emoji: "📦", text: t.trustDoor },
    { emoji: "⚡", text: t.trustFast },
    { emoji: "🌍", text: t.trustGlobal },
  ];
  ...
  return (
    <Box sx={{
      ...
      <Container maxWidth="md" sx={{ position: "relative", zIndex: 1, textAlign: "center" }}>
        <Typography sx={{ fontFamily: font, fontWeight: 800, fontSize: "0.7rem", color: "rgba(255,255,255,0.6)", letterSpacing: isRTL ? 0 : 3, textTransform: "uppercase", mb: 2 }}>
          {t.readyToShip}
        </Typography>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={2} justifyContent="center">
          <Button variant="contained" onClick={() => navigate("/tracking")}
            endIcon={!isRTL && <ArrowForwardIosIcon sx={{ fontSize: "11px !important" }} />}
            startIcon={isRTL && <ArrowForwardIosIcon sx={{ fontSize: "11px !important", transform: "rotate(180deg)" }} />}
